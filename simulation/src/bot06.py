...
''' This script is for brute forcing buy/sell margin back testing to two decimal points
    (Slower, most accurate)
    ONLY USE FOR DAY DATA
    Minute data is too much and would take forever
'''
...
# Generate range to iterate over, two decimal points (10000 intervals)
interval = np.linspace(0,100,10000)

for buy_margin in interval:
    if buy_margin % 1 == 0:
        print(f"Progress: {buy_margin}")
    for sell_margin in interval:
        track = []
